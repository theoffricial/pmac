...
export interface PmacWorkspaceCreateCtx {
    workspaceName: string
    workspaceType: WorkspaceType
    workspaceDescription?: string
    workspaceJson?: PMACWorkspace
}
...
const createWorkspaceDirTask: ListrTask<PmacWorkspaceCreateCtx> =  {
  ...
  task: async ctx => {
    ...
    await fsWorkspaceManager.createPMACWorkspaceDir(ctx.workspaceJson)
  },
}
...
const writeWorkspaceJsonToDirTask: ListrTask<PmacWorkspaceCreateCtx> = {
  ...
  task: async ctx => {
    ...
    await fsWorkspaceManager.writeWorkspaceDataJson(ctx.workspaceJson)
  },
}
